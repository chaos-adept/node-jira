...
(function() {
    ...
    // ### Returns ###
    // *  error string
    // *  success Body if Jira response (the created worklog object)
    //
    ...
    // ## Delete a worklog from a project ##
    // ### Takes ###
    // *  issueId: Issue to add a worklog to
    ...
    //
    // [Jira Doc](http://docs.atlassian.com/jira/REST/latest/#id291617)
    this.getWorklog = function(issueId, callback) {
        var options = {
            rejectUnauthorized: this.strictSSL,
        ...
        this.doRequest(options, function(error, response, body) {
            ...
            callback(response.statusCode + ': Error while get Worklog');
